[33mcommit f9ec1e90d0a32572f6604909eacffba36e3375c8[m[33m ([m[1;36mHEAD -> [m[1;32mmaster[m[33m, [m[1;32mavinash[m[33m)[m
Author: Ubuntu <avinash@avinashvm.ty2ydrqdjomepmy0lvy1lwkcxh.tx.internal.cloudapp.net>
Date:   Fri Apr 14 04:16:40 2023 +0000

    first commit

[1mdiff --git a/.bash_logout b/.bash_logout[m
[1mnew file mode 100644[m
[1mindex 0000000..de4f5f7[m
[1m--- /dev/null[m
[1m+++ b/.bash_logout[m
[36m@@ -0,0 +1,7 @@[m
[32m+[m[32m# ~/.bash_logout: executed by bash(1) when login shell exits.[m
[32m+[m
[32m+[m[32m# when leaving the console clear the screen to increase privacy[m
[32m+[m
[32m+[m[32mif [ "$SHLVL" = 1 ]; then[m
[32m+[m[32m    [ -x /usr/bin/clear_console ] && /usr/bin/clear_console -q[m
[32m+[m[32mfi[m
[1mdiff --git a/.bashrc b/.bashrc[m
[1mnew file mode 100644[m
[1mindex 0000000..b488fcc[m
[1m--- /dev/null[m
[1m+++ b/.bashrc[m
[36m@@ -0,0 +1,117 @@[m
...
[32m+[m[32mesac[m
[32m+[m
[32m+[m[32m# don't put duplicate lines or lines starting with space in the history.[m
[32m+[m[32m# See bash(1) for more options[m
[32m+[m[32mHISTCONTROL=ignoreboth[m
[32m+[m
...
[32m+[m
[32m+[m[32m# If set, the pattern "**" used in a pathname expansion context will[m
[32m+[m[32m# match all files and zero or more directories and subdirectories.[m
[32m+[m[32m#shopt -s globstar[m
[32m+[m
...
[32m+[m[32m    xterm-color|*-256color) color_prompt=yes;;[m
[32m+[m[32mesac[m
[32m+[m
...
[32m+[m[32mfi[m
[32m+[m
[32m+[m[32m# colored GCC warnings and errors[m
[32m+[m[32m#export GCC_COLORS='error=01;31:warning=01;35:note=01;36:caret=01;32:locus=01:quote=01'[m
[32m+[m
...
[32m+[m
[32m+[m[32m# Add an "alert" alias for long running commands.  Use like so:[m
[32m+[m[32m#   sleep 10; alert[m
[32m+[m[32malias alert='notify-send --urgency=low -i "$([ $? = 0 ] && echo terminal || echo error)" "$(history|tail -n1|sed -e '\''s/^\s*[0-9]\+\s*//;s/[;&|]\s*alert$//'\'')"'[m
[32m+[m
...
[32m+[m[32mif ! shopt -oq posix; then[m
[32m+[m[32m  if [ -f /usr/share/bash-completion/bash_completion ]; then[m
[32m+[m[32m    . /usr/share/bash-completion/bash_completion[m
[32m+[m[32m  elif [ -f /etc/bash_completion ]; then[m
[32m+[m[32m    . /etc/bash_completion[m
[32m+[m[32m  fi[m
[32m+[m[32mfi[m
[1mdiff --git a/.cache/motd.legal-displayed b/.cache/motd.legal-displayed[m
[1mnew file mode 100644[m
[1mindex 0000000..e69de29[m
[1mdiff --git a/.profile b/.profile[m
[1mnew file mode 100644[m
[1mindex 0000000..d89ea5a[m
[1m--- /dev/null[m
[1m+++ b/.profile[m
[36m@@ -0,0 +1,27 @@[m
[32m+[m[32m# ~/.profile: executed by the command interpreter for login shells.[m
[32m+[m[32m# This file is not read by bash(1), if ~/.bash_profile or ~/.bash_login[m
[32m+[m[32m# exists.[m
[32m+[m[32m# see /usr/share/doc/bash/examples/startup-files for examples.[m
[32m+[m[32m# the files are located in the bash-doc package.[m
[32m+[m
[32m+[m[32m# the default umask is set in /etc/profile; for setting the umask[m
[32m+[m[32m# for ssh logins, install and configure the libpam-umask package.[m
[32m+[m[32m#umask 022[m
[32m+[m
[32m+[m[32m# if running bash[m
[32m+[m[32mif [ -n "$BASH_VERSION" ]; then[m
[32m+[m[32m    # include .bashrc if it exists[m
[32m+[m[32m    if [ -f "$HOME/.bashrc" ]; then[m
[32m+[m	[32m. "$HOME/.bashrc"[m
[32m+[m[32m    fi[m
[32m+[m[32mfi[m
[32m+[m
[32m+[m[32m# set PATH so it includes user's private bin if it exists[m
[32m+[m[32mif [ -d "$HOME/bin" ] ; then[m
[32m+[m[32m    PATH="$HOME/bin:$PATH"[m
[32m+[m[32mfi[m
[32m+[m
[32m+[m[32m# set PATH so it includes user's private bin if it exists[m
[32m+[m[32mif [ -d "$HOME/.local/bin" ] ; then[m
[32m+[m[32m    PATH="$HOME/.local/bin:$PATH"[m
[32m+[m[32mfi[m
[1mdiff --git a/.ssh/authorized_keys b/.ssh/authorized_keys[m
[1mnew file mode 100644[m
[1mindex 0000000..e69de29